...
resource "google_compute_instance" "instance-20241014-072201" {
  boot_disk {
    auto_delete = true
    device_name = "instance-20241014-072201"
  ...
  network_interface {
    ...
    subnetwork  = "projects/rancher-438604/regions/us-central1/subnetworks/default"
  }
  ...
  service_account {
    email  = "759188993839-compute@developer.gserviceaccount.com"
